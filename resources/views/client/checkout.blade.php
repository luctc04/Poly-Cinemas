                                    ...
                                    <div class="col-md-12 box-list-status-seat">
                                        ...
                                        <div class="payment-checkout">
                                            ...
                                            <div class="img-payment-checkout">
                                                ...
                                                <div>
                                                    <input type="radio" name="payment_name" value="vietqr"
                                                        id="payment-checkout-2">
                                                    <label for="payment-checkout-2"><img style="border: 1.4px solid #d7d7d7; border-radius: 5px"
                                                            src="{{ asset('theme/client/images/index_III/vietqr.png') }}"> Việt QR</label>
                                                </div>
                                            </div>
                                        </div>
